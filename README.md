...
11. กดบันทึกข้อมูล
12. ถ้าต้องการปิดรับสมัครเองภายหลัง ให้เปิด Google Sheet แล้วเปลี่ยนคอลัมน์ `isClosed` ของกิจกรรมนั้นเป็น `TRUE`
...
- ถ้ากิจกรรมปิดรับสมัครเองก่อนกำหนด ให้แก้ `isClosed` ใน Google Sheet เป็น `TRUE` หน้าเว็บจะแสดงป้าย `ปิดรับสมัคร`; ถ้ายังเปิดรับสมัครให้ใช้ `FALSE`
